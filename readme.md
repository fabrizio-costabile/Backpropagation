...
UML class diagram (located in **/docs** folder) showing the project's structure that includes a **Strategy Pattern** that enables the selection of the Neuron's **Activation Function**.
